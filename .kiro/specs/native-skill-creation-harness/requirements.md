...
The authoritative source is `/Users/huijoohwee/Documents/GitHub/joohwee/prd-tad-ard/acos-agentic-runtime-ready-production-verified-prd-tad-adr.md` (PRD + Architecture/TAD + ADR-1 + ADR-2 + Readiness Gap Matrix). Every VCC stated there maps to at least one acceptance criterion below.
