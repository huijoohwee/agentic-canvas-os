...
test("source-bound host component packs are bounded, deterministic, and inert", () => {
  for (const required of [
    ...
    /`workspace:\/`, `kgdoc:`, and `urn:agentic-graph:`/,
  ...
  assert.match(application, /`workspace:\/SEG\[\/SEG\.\.\.\]`, `kgdoc:SEG\[\/SEG\.\.\.\]`, and `urn:agentic-graph:SEG\[:SEG\.\.\.\]`/);
  ...
  assert.match(application, /`agentic-graph\.application\.catalog` returns its current digests, while plan and execute reject the stale proof/);
