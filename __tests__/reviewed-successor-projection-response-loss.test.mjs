...
import {
  AUTHORIZATION_PREFIX, MUTATION_POLICY, buildReviewedSuccessorProjectionResponseLossPlan,
...
function fixture() {
  ...
  const evidenceCore = {
    observedAt: "2026-08-16T06:00:00.000Z", repository: "huijoohwee/agentic-canvas-os", actorId: "actor", workItemId: "repository-teardown", branch: "agent/device/repository-teardown", sessionId: "session", local, remoteHeadSha: head,
