...
import { PRESERVED_ROUTE_SET, buildRecord, executeCorpus, parseOptions, validateCorpus, validateRecord } from "../scripts/runtime-route-contract.mjs";

const corpus = validateCorpus(JSON.parse(await readFile(new URL("../docs/runtime-route-contract/route-corpus.json", import.meta.url))));
