...
base, pull-request identity, heads, and clean worktree are re-read before proof
capture. Fetch failure or any post-fetch drift preserves v1 and stops before the
rollover CAS.
