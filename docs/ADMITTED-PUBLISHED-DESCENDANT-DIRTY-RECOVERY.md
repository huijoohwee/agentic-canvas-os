...
If projection also lands before local persistence, replay proves the exact counter-plus-two published
head and reconstructs the recovery operation receipt from its validated raw-ledger prefix. The local
cloud authority is then built by the shared continuation reconciler, not the fresh-claim normalizer.
