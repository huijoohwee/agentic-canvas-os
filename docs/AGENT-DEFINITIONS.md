...
runtime_claim: "local registry behavior is runtime-ready in Dev and one source-backed proof definition completed bounded live execution; the default Worker still registers no agents"
