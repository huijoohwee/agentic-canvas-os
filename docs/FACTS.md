...
| Kanban collaboration inspiration | Context-reference patterns may inform how agents attach board rows or context refs, but the durable multi-agent board is local `huijoohwee.github.io/docs/kanban.md` plus shared table/Kanban utilities. | This file, dictionaries, `huijoohwee.github.io/docs/kanban.md`, and `HARNESS-CONTRACTS.md`. |
...
| `/kanban.task` | `DICTIONARY-COMMAND.md` | Route for creating or updating one durable task row in `huijoohwee.github.io/docs/kanban.md`. | Validate row schema through shared table/Kanban utilities; require owner profile, status, evidence, acceptance, and next action. |
...
| `/kanban.sync` | `DICTIONARY-COMMAND.md` | Route for reconciling board rows across worker processes. | Preserve `huijoohwee.github.io/docs/kanban.md` as SSOT, surface conflicts, and avoid hidden worker memory as the source of truth. |
...
| `#kanban-board` | `DICTIONARY-SEMANTIC.md` | Semantic route for the durable shared task board. | Board rows stay in `huijoohwee.github.io/docs/kanban.md` and render through existing multi-dimensional table/Kanban utilities. |
...
| `@kanban-board` | `DICTIONARY-BINDING.md` | Binding for `huijoohwee.github.io/docs/kanban.md`. | Board is the durable SSOT; no duplicate browser-only or process-local task store. |
...
| Kanban board | `huijoohwee.github.io/docs/kanban.md` is the durable shared task board for named profiles and worker processes. | `/kanban.task`, `#kanban-board`, `@kanban-board`. |
...
| Cross-repository planning index | `huijoohwee.github.io/docs/TODO.md` owns routing; immutable `huijoohwee.github.io/todo/YYYY-MM/<context>.md` records own new task plans, while flat monthly shards preserve legacy history. | `huijoohwee.github.io/docs/TODO.md`, `todo-context-record/v2`, `VALIDATION-RUNBOOK.md`. |
| Planning record lifecycle | Each stable Context owns one immutable record; exact Context retrieval precedes deterministic date/Context/source projection, and legacy monthly shards never change. | `huijoohwee.github.io/docs/TODO.md` lifecycle, retrieval, and projection contracts. |
| Planning authority | `huijoohwee.github.io/docs/TODO.md` and independently claimed Context records are the sole live planning SSOT for participating repositories; shared writable planning indexes and repository-local todo files are forbidden. | The pinned ADLC start/release workflows and `VALIDATION-RUNBOOK.md`. |
| Planning update compliance | A task creates one base-absent Context record with one canonical 11-cell row, a Directive of at most 50 words, and matching dates; no legacy or extra record path may change. | `huijoohwee.github.io/docs/TODO.md` and `planning-context-record-contract.mjs`. |
...
| Planning history | Flat `huijoohwee.github.io/todo/YYYY-MM.md` files preserve immutable legacy rows; new `huijoohwee.github.io/todo/YYYY-MM/<context>.md` files store immutable task records; `huijoohwee.github.io/docs/TODO.md` owns routing and validation. | `huijoohwee.github.io/docs/TODO.md` and the pinned ADLC start/release workflows. |
