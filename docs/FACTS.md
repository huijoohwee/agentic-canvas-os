...
source_revision_contract:
  ...
  canonical_rule: "the Agentic Canvas OS local supervisor may serve fixed local ports only from clean registered main worktrees whose HEAD equals fetched origin/main and whose required protected checks succeeded; task worktrees never own canonical runtime ports"
