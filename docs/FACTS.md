...
| `/knowledge.graph.explain` | `DICTIONARY-COMMAND.md` | Route from one exact edge identity to `knowgrph.knowledge_graph.explain_edge`. | Return stored endpoints, relationship kind, resolution class, explanation, and source evidence without reparsing, generation, or mutation. |
