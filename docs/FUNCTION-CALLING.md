...
runtime_owner: "../agent-api/src/function-calling.js; ../agent-api/src/function-calling-manager.js; ../agent-api/src/function-execution-receipts.js; ../agent-api/src/openai-responses-function-adapter.js; ../agent-api/src/agentic-graph-function-gateway.js; ../agent-api/src/agentic-graph-function-tools.js; ../scripts/live-function-run-note-proof.mjs"
