...
| Execute | Validated arguments, direct caller, and policy metadata | Gateway envelope, bounded output, or review pause | Tool guardrails and exact signed review remain beside the real gateway. |
