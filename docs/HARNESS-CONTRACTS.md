...
| Canvas Dashboard | Project source-backed run state into Canvas | Markdown/frontmatter + typed manifest | Agentic OS/frontmatter graph and Storyboard cards | Mutation only when writing source docs |
