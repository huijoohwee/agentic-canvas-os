...
runtime_claim: "local resolution is runtime-ready in Dev and one explicit model and transport completed bounded live execution; the default Worker adapter remains unconfigured"
