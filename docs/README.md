...
| `SOURCE-INVENTORY-CONTRACT.md` | Canonical source inventory contract | Revision-bound complete inventories, source-owned fallback, portable reader projections, atomic replacement, and cross-device parity. |
