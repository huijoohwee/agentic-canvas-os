...
| `FUNCTION-CALLING.md` | Direct function-call runtime | Strict schemas, exact call-id continuation, guarded Knowgrph execution, signed-review boundary, bounds, costs, and live-provider proof gates. |
