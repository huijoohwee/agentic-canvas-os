...
| `FUNCTION-CALLING.md` | Direct function-call runtime | Strict schemas, exact call identity, durable reviewed-call continuation, guarded Knowgrph execution, costs, and live-provider proof gates. |
