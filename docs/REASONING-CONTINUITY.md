...
authority: "Canvas integration of the pinned OS continuity runtime"
...
The portable implementation and API contract moved to `agentic-os/context/continuity`.
...
Run `npm run reasoning-continuity:check` for Canvas application injection and readiness.
