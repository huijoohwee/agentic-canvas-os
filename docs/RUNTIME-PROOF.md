...
| PMF Agent routes hold | `/pmf-agent`, `#pmf-agent`, and `@pmf-agent` resolve once from the command, semantic, and binding dictionaries; `agent.pmf` compiles zero-spend; `/product-market-fit-agent` remains unsupported. | Passed |
