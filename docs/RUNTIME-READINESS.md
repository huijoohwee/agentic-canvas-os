...
| Invocation dictionaries | `/`, `#`, and `@` dictionaries are source-backed. | `DICTIONARY-COMMAND.md`, `DICTIONARY-SEMANTIC.md`, `DICTIONARY-BINDING.md`, and the count-and-digest contract parse and fence 406 entries. | Contract-tested; no ACOS runtime route consumes the resolver directly |
