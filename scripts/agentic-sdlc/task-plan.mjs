...
function transitionViolationRuleId(kind) {
  const rules = {
    ...
    "unknown-state": "task-model#11",
    "terminal-transition": "task-model#13",
    "invalid-rederivation": "task-model#13",
    "invalid-transition": "task-model#11",
    "invalid-verifier": "agent-roles--independence#8",
    "invalid-role": "agent-roles--independence#9",
    "missing-reason": "task-model#12",
    "unknown-declared-state": "task-model#11",
    "state-without-transition": "task-model#14",
    "state-mismatch": "task-model#14",
  };
