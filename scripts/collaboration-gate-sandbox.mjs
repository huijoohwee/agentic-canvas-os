...
export function createCollaborationGateSandbox({
  ...
  const environment = {
    ...
    KG_COLLABORATION_E2E_OWNER_URL: `http://127.0.0.1:${allocation.ports.owner}/`,
    KG_COLLABORATION_E2E_GUEST_URL: `http://127.0.0.1:${allocation.ports.guest}/`,
    KG_COLLABORATION_E2E_WORKER_URL: `http://127.0.0.1:${allocation.ports.worker}`,
    KG_COLLABORATION_E2E_PERSISTENCE_PATH: persistencePath,
    KG_COLLABORATION_E2E_RESULT_PATH: proofPath,
    KG_COLLABORATION_E2E_SCREENSHOT_PREFIX: screenshotPrefix,
    KG_COLLABORATION_E2E_WORKSPACE_ID: `kgws:collaboration-gate:${identitySuffix}`,
    KG_COLLABORATION_E2E_OWNER_TOKEN: `kg_owner_${randomUUID().replaceAll("-", "")}`,
    KG_COLLABORATION_E2E_GUEST_TOKEN: `kg_guest_${randomUUID().replaceAll("-", "")}`,
    KG_COLLABORATION_E2E_OWNER_DEVICE: `collaboration-owner-${identitySuffix}`,
    KG_COLLABORATION_E2E_GUEST_DEVICE: `collaboration-guest-${identitySuffix}`,
    KG_COLLABORATION_E2E_OWNER_DEVICE_ID: `dev:collaboration-owner:${identitySuffix}`,
    KG_COLLABORATION_E2E_GUEST_DEVICE_ID: `dev:collaboration-guest:${identitySuffix}`,
  };
