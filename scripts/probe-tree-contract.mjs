const PROBE_TREE_PRESET_ID = "agentic-graph-probe-tree";
...
export function validateProbeTreeContractDocuments(documents) {
  ...
  requireMarkers(findTableRow(command, "/agentic-graph.probe-tree"), "DICTIONARY-COMMAND.md Probe-Tree row", [
    ...PROBE_TREE_CLARIFICATION_TOPICS,
    "2-4",
    "runtime-recognized selected-child terminal continuation",
    "active Chat provider, endpoint, and model",
  ...
  requireMarkers(findTableRow(semantic, "#agentic-graph.probe-tree"), "DICTIONARY-SEMANTIC.md Probe-Tree row", [
    "semantic and case-insensitive",
    "2-4",
    "runtime-recognized selected-child terminal continuation",
  ], failures);
  requireMarkers(findTableRow(binding, "@agentic-graph.probe-tree"), "DICTIONARY-BINDING.md Probe-Tree row", [
    "selected child",
    "active Chat provider, endpoint, and model",
